...
def train_model(model, criterion, criterion_val, optimizer, epochs, batch_size,
    ...
    for epoch in range(epochs):
        ...
        torch.save(model, './Model/model_'+suffix+'_epoch'+str(epoch+1)+'.pth')
...
def model_performance_run(suffix,sequence_tensor_test,label_tensor_test,epoch_num=20):
    ...
    for epoch in range(epoch_num):
        result_dict_tmp = {}
        model1_best = torch.load('./Model/model_'+suffix+'_epoch'+str(epoch+1)+'.pth')
...
def model_performance_run_forOne(suffix,sequence_tensor_test,label_tensor_test,epoch):
    model1_best = torch.load('./Model/model_'+suffix+'_epoch'+str(epoch)+'.pth')
    model1_best = model1_best.eval()
...
def train_model_run(sequence_tensor_train, label_tensor_train, sequence_tensor_val, label_tensor_val, suffix, length, epoch_num=20, weight=False, if_data_augment=True, lr=1e-4, weight_decay=1e-4):
    device=torch.device('cuda:0')
    model = Stransformer(int(length/32))
...
sequence_tensor_train_deseq_v1_bM10 = torch.load('./TrainData/epi_tensor_train.pt')
sequence_tensor_val_deseq_v1_bM10 = torch.load('./TrainData/epi_tensor_val.pt')
sequence_tensor_test_deseq_v1_bM10 = torch.load('./TrainData/epi_tensor_test.pt')
label_tensor_train_deseq_v1_bM10 = torch.load('./TrainData/label_tensor_train.pt')
label_tensor_val_deseq_v1_bM10 = torch.load('./TrainData/label_tensor_val.pt')
label_tensor_test_deseq_v1_bM10 = torch.load('./TrainData/label_tensor_test.pt')

sequence_tensor_train_deseq_v1_bM10 = torch.cat((sequence_tensor_train_deseq_v1_bM10[:,:,:3,:], sequence_tensor_train_deseq_v1_bM10[:,:,4:,:]),dim=2)
sequence_tensor_val_deseq_v1_bM10 = torch.cat((sequence_tensor_val_deseq_v1_bM10[:,:,:3,:], sequence_tensor_val_deseq_v1_bM10[:,:,4:,:]),dim=2)
sequence_tensor_test_deseq_v1_bM10 = torch.cat((sequence_tensor_test_deseq_v1_bM10[:,:,:3,:], sequence_tensor_test_deseq_v1_bM10[:,:,4:,:]),dim=2)

sequence_tensor_val_deseq_v1_bM10_augment, label_tensor_val_deseq_v1_bM10_augment = \
data_augment_ValTest(sequence_tensor_val_deseq_v1_bM10, label_tensor_val_deseq_v1_bM10)
sequence_tensor_test_deseq_v1_bM10_augment, label_tensor_test_deseq_v1_bM10_augment = \
data_augment_ValTest(sequence_tensor_test_deseq_v1_bM10, label_tensor_test_deseq_v1_bM10)

## Random downsampling

sequence_tensor_train_deseq_v1_bM10_balanced, label_tensor_train_deseq_v1_bM10_balanced = \
balances_data(sequence_tensor_train_deseq_v1_bM10, label_tensor_train_deseq_v1_bM10)
length = 1152
cut = (1536-(length))/2
sequence_tensor_train_deseq_v1_bM10_balanced_cut = sequence_tensor_train_deseq_v1_bM10_balanced[:,:,:,int(cut):int(1536-cut)].clone()
sequence_tensor_val_deseq_v1_bM10_augment_cut = sequence_tensor_val_deseq_v1_bM10_augment[:,:,:,int(cut):int(1536-cut)].clone()
sequence_tensor_test_deseq_v1_bM10_augment_cut = sequence_tensor_test_deseq_v1_bM10_augment[:,:,:,int(cut):int(1536-cut)].clone()

sequence_tensor_train = sequence_tensor_train_deseq_v1_bM10_balanced_cut
sequence_tensor_val = sequence_tensor_val_deseq_v1_bM10_augment_cut
label_tensor_train = label_tensor_train_deseq_v1_bM10_balanced
label_tensor_val = label_tensor_val_deseq_v1_bM10_augment

## Model training
weight_decay=1e-3
epoch_num = 50000
length = sequence_tensor_train.shape[3]
print(length)
suffix = 'Length1152'
length_res['train_loss'], length_res['val_loss'], length_res['best_epoch'], length_res['best_loss'] = \
train_model_run(sequence_tensor_train, label_tensor_train, sequence_tensor_val, label_tensor_val,\
